...
import TriviaGrid from '../../components/home-components/Categorias';
...
<section className='mt-8 w-4/5 mx-auto'>
  <div className='bg-white font-Roboto py-5'>
    ...
    <p className='text-center'>Actividades creadas de nuestros usuarios</p>
  </div>
        ...
        <section className='flex flex-col'>
          ...
          <div className='flex flex-row gap-16'>
            ...
            <div className='bg-Gris p-4 flex flex-col gap-2  w-60 border-gray-400  justify-center items-center  text-center  rounded-2xl shadow-custom'>
              ...
              <p  className='font-Roboto text-black'>Comparta con sus alumnos copiando solamente un enlace.</p>
            </div>
