    ...
    <>
      ...
      <div className='flex justify-center items-center bg-white w-full p-12'>
        <section className='flex flex-col'>
          <h1 className='text-center m-4 font-bold text-4xl'>
            ¿Como Funciona?
          </h1>
        ...
        <section className='flex flex-col w-full'>
          ...
          <div className='flex flex-row justify-center items-center'>
            <div className='flex flex-col w-2/6 justify-center items-center gap-8'>
              ...
              <button className='bg-pink-500 text-white border-pink-500 border-solid border-2 p-1 rounded-md hover:text-pink-500 hover:bg-white transition duration-500'>
                Crear actividad
              </button>
            </div>
            <picture className='w-1/2'>
