...
import LogoPlayChess from '../../../assets/Home-Images/logoPlayChess.svg';
    ...
    <header className=' bg-white my-10 h-20'>
      <div className='flex  items-center justify-between px-4 max-w-7xl mx-auto'>
        ...
        <div className='flex items-center gap-4'>
          <Link to={'/crear-juego'}>
            <button className='flex font-Roboto text-center content-center hover:text-blue-950  hover:fill-blue-950 transition duration-500'>
